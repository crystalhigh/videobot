<template>
  <div id="page-respond-mobile">
    <!-- answer is Open Ended -->
    <div v-if="!collect" class="w-100 h-100 d-flex align-items-end">
      <!-- video audio text -->
      <div
        v-if="step && step.answer.type === 0"
        class="w-100 h-100 d-flex align-items-end justify-content-center"
      >
      <div class="open-ended-wrapper">
        <a @click="nextStepByLogo" class="page-respone-live-logo"><img src="/images/logo-new1.png" /></a>
      </div>
        <!-- <div v-if="mode === 'select'" class="w-100 mb-5 px-5">
      ...
      <!-- multiple choice -->
      <div v-if="step && step.answer.type === 1" class="w-100 mb-5">
        <h6 class="text-center mb-3" v-if="step.answer.option.show_count">
          Choose 1 of {{ this.choices.length }} options
        </h6>
        <div class="multiple-choice-wrapper" :class="fitVideo ? 'fit' : ''">
          <button
            type="button"
      ...
      <!-- button content -->
      <div v-if="step && step.answer.type === 2" class="w-100 mb-5 px-5">
        <button
          type="button"
          class="btn btn-answer"
      ...
      <!-- calendly -->
      <div v-if="step && step.answer.type === 3" class="w-100 calendly-wrapper">
        <vue-calendly
      ...
      <!-- payment -->
      <div v-if="step && step.answer.type === 4" class="w-100 mb-5 px-5">
    ...
    <div v-else class="collect-data-wrapper">
      <div class="collect-data-wrapper-content">
        ...
        <b-form-group
          ...
          label-for="collect-street-address"
          class="mt-3"
        >
      ...
      <button type="button" class="btn btn-answer" @click="handleSubmit">
        Next
      </button>
    </div>
  </div>
...
export default {
  ...
  props: {
    ...
    fitVideo: { type: Boolean, default: false },
  ...
  mounted() {
    ...
    this.countrySuggestions = this.country;
    // this.$nextTick(() => {
    //   const phone = document.getElementById('collect-phone-mobile');
